# file for the functions that aren't the core EDM functions but will be 
...
#------------------------------------------------------------------------
# Function to run a set of EDM examples. Prints the function call
# use to produce the computation/plot. 
#------------------------------------------------------------------------
def Examples():
